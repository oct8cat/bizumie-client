...
module.exports = withApollo(class UploadPlus extends React.Component {
  constructor (props) {
    super(props)
  ...
  render () {
    return (
      <form>
        <input type='file' name='upload' required onChange={this.handleChange} style={{display: 'none'}} />
        <Button type='button' icon='add' basic circular onClick={this.handleClick} />
      </form>
    )
  }
  handleClick (e) {
  ...
  handleChange (e) {
    ...
    window
      ...
      .then((json) => {
        ...
        data.uploads = (data.uploads || []).concat(Object.assign({__typename: 'Upload'}, upload))
